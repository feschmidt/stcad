...
inductor = SpiralInductor(exterior = 35,coil_number = 30,kinetic_inductance = 6.e-12)
print inductor.Lk*1e9
print inductor.Lg*1e9
print inductor.Lg*1e9+inductor.Lk*1e9
print inductor.C*1e15
print inductor.self_resonance/1e9
print inductor.resonance(1e-15)/1e9
print 

inductor = SpiralInductor(exterior = 41,coil_number = 30,kinetic_inductance = 6.e-12)
print inductor.Lk*1e9
print inductor.Lg*1e9
print inductor.Lg*1e9+inductor.Lk*1e9
print inductor.C*1e15
print inductor.self_resonance/1e9
print inductor.resonance(4e-15)/1e9
